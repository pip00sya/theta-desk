...
|---|-------|-------|-----------------|
| 01 | journal_entries | 321 | `python tools/reconcile.py` |
| 02 | journal_chain | intact | `python tools/reconcile.py` |
| 03 | ticks | 33 | `python tools/reconcile.py` |
...
| 07 | structures_open | 0 | `python tools/reconcile.py` |
| 08 | structures_closed | 4 | `python tools/reconcile.py` |
| 09 | realized_pnl_usd | 947.00 | `python tools/reconcile.py` |
