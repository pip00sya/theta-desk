...
|---|-------|-------|-----------------|
| 01 | journal_entries | 67 | `python tools/reconcile.py` |
| 02 | journal_chain | intact | `python tools/reconcile.py` |
| 03 | ticks | 8 | `python tools/reconcile.py` |
| 04 | gate_evaluations | 4 | `python tools/reconcile.py` |
| 05 | entries_refused_by_gates | 2 | `python tools/reconcile.py` |
| 06 | structures_total | 1 | `python tools/reconcile.py` |
...
| 10 | book_worst_case_peak_usd | 765 | `python tools/reconcile.py` |
| 11 | order_transports_used | dry_run,rest | `python tools/reconcile.py` |
